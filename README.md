[![](https://travis-ci.org/caodhuan/SimpleServer.svg?branch=master)](https://travis-ci.org/caodhuan/SimpleServer) ![](https://img.shields.io/badge/language-cpp-brightgreen.svg)
# SimpleServer
一个 mmo 游戏服务器。
